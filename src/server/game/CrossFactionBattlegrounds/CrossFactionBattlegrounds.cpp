...
#include "CrossFactionBattlegrounds.h"
...
bool Player::SendRealNameQuery()
{
    ...
    Player* player = ObjectAccessor::FindPlayer(GetGUID());
    CharacterNameData const* nameData = sWorld->GetCharacterNameData(GUID_LOPART(GetGUID()));
