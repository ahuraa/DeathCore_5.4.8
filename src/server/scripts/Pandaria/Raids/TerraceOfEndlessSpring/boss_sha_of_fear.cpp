...
////                        if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 80.f))
////                        {
...
////                        events.ScheduleEvent(EVENT_OMINOUS_CACKLE, (me->GetMap()->GetDifficulty() == RAID_DIFFICULTY_10MAN_HEROIC || me->GetMap()->GetDifficulty() == RAID_DIFFICULTY_10MAN_NORMAL) ? 90000 : 45000);
...
//    };
//    
//	class npc_sha_of_fear_bowma : public CreatureScript
//	{
//	public:
//		npc_sha_of_fear_bowma() : CreatureScript("npc_sha_of_fear_bowma") { }
//
//		struct npc_sha_of_fear_bowmaAI : public BossAI
//		{
//			npc_sha_of_fear_bowmaAI(Creature* creature) : BossAI(creature, DATA_SHA_OF_FEAR)
//		}
//
//		{}
//		EventMap events;
...
//    };
//
//    class npc_sha_globeAI : public CreatureScript
//    {
//    public:
//        npc_sha_globeAI() : CreatureScript("npc_sha_globe") { }
//
//        struct npc_sha_globe : public BossAI
//        {
//            npc_sha_globe(Creature* creature) : BossAI(creature, DATA_SHA_OF_FEAR) {}
//
//            void Reset()
//            {
