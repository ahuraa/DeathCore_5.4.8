            ...
            void Reset() override
            {
                ...
                if (instance)
                {
                    ...
                    else
                    {
                        ...
                        me->setFaction(35);
						me->SetUInt32Value(UNIT_FIELD_NPC_EMOTESTATE, 35);
                    }
                }
            }
...
public:
    ...
    class spell_impl : public SpellScript
    {
        ...
        void HandleOnHit()
        {
			...
			if (pCaster->GetExactDist2d(pBeam) < pBeam->GetFloatValue(OBJECT_FIELD_SCALE))
            {
...
public:
    ...
    class spell_impl : public SpellScript
    {
        ...
        void SelectTargets(std::list<WorldObject*>&targets)
        {
            ...
            {
				uint32 m_maxTargets = (pCaster->GetMap()->GetDifficulty() == RAID_DIFFICULTY_25MAN_NORMAL || pCaster->GetMap()->GetDifficulty() == RAID_DIFFICULTY_25MAN_HEROIC) ? 5 : 2;
