...
class npc_apparition_of_fear : public CreatureScript
{
    public:
        ...
        struct npc_apparition_of_fearAI : public BossAI
        {
            npc_apparition_of_fearAI(Creature* creature) : BossAI(creature, 64368)
            {
...
class npc_apparition_of_terror : public CreatureScript
{
    public:
        ...
        struct npc_apparition_of_terrorAI : public BossAI
        {
            npc_apparition_of_terrorAI(Creature* creature) : BossAI(creature, 66100)
            {
                pInstance = creature->GetInstanceScript();
            }
